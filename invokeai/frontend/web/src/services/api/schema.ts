...
export type components = {
  schemas: {
    ...
    Graph: {
       ...
       */
      nodes: {
        [key: string]: components["schemas"]["StepParamEasingInvocation"] | components["schemas"]["MetadataItemInvocation"] | components["schemas"]["ConditioningInvocation"] | components["schemas"]["FaceIdentifierInvocation"] | components["schemas"]["DWOpenposeImageProcessorInvocation"] | components["schemas"]["IPAdapterInvocation"] | components["schemas"]["ImageChannelMultiplyInvocation"] | components["schemas"]["PidiImageProcessorInvocation"] | components["schemas"]["ImageToLatentsInvocation"] | components["schemas"]["MaskEdgeInvocation"] | components["schemas"]["InfillTileInvocation"] | components["schemas"]["CompelInvocation"] | components["schemas"]["NormalbaeImageProcessorInvocation"] | components["schemas"]["ImageConvertInvocation"] | components["schemas"]["TileToPropertiesInvocation"] | components["schemas"]["RangeOfSizeInvocation"] | components["schemas"]["ContentShuffleImageProcessorInvocation"] | components["schemas"]["LineartImageProcessorInvocation"] | components["schemas"]["CreateGradientMaskInvocation"] | components["schemas"]["RandomRangeInvocation"] | components["schemas"]["ColorCorrectInvocation"] | components["schemas"]["StringSplitNegInvocation"] | components["schemas"]["ESRGANInvocation"] | components["schemas"]["SegmentAnythingProcessorInvocation"] | components["schemas"]["ImageCollectionInvocation"] | components["schemas"]["DenoiseLatentsInvocation"] | components["schemas"]["ImageMultiplyInvocation"] | components["schemas"]["CreateDenoiseMaskInvocation"] | components["schemas"]["LaMaInfillInvocation"] | components["schemas"]["SDXLLoRALoaderInvocation"] | components["schemas"]["AddInvocation"] | components["schemas"]["DepthAnythingImageProcessorInvocation"] | components["schemas"]["CannyImageProcessorInvocation"] | components["schemas"]["MainModelLoaderInvocation"] | components["schemas"]["ImageChannelInvocation"] | components["schemas"]["TileResamplerProcessorInvocation"] | components["schemas"]["ConditioningCollectionInvocation"] | components["schemas"]["SaveImageInvocation"] | components["schemas"]["CollectInvocation"] | components["schemas"]["ImageInverseLerpInvocation"] | components["schemas"]["BooleanInvocation"] | components["schemas"]["MlsdImageProcessorInvocation"] | components["schemas"]["StringCollectionInvocation"] | components["schemas"]["CalculateImageTilesEvenSplitInvocation"] | components["schemas"]["ZoeDepthImageProcessorInvocation"] | components["schemas"]["ScaleLatentsInvocation"] | components["schemas"]["CvInpaintInvocation"] | components["schemas"]["LatentsInvocation"] | components["schemas"]["LatentsCollectionInvocation"] | components["schemas"]["InfillPatchMatchInvocation"] | components["schemas"]["RandomFloatInvocation"] | components["schemas"]["ImageHueAdjustmentInvocation"] | components["schemas"]["SDXLCompelPromptInvocation"] | components["schemas"]["FreeUInvocation"] | components["schemas"]["ImageLerpInvocation"] | components["schemas"]["MultiplyInvocation"] | components["schemas"]["MaskFromAlphaInvocation"] | components["schemas"]["LineartAnimeImageProcessorInvocation"] | components["schemas"]["DivideInvocation"] | components["schemas"]["ColorMapImageProcessorInvocation"] | components["schemas"]["SchedulerInvocation"] | components["schemas"]["SeamlessModeInvocation"] | components["schemas"]["CV2InfillInvocation"] | components["schemas"]["T2IAdapterInvocation"] | components["schemas"]["MergeTilesToImageInvocation"] | components["schemas"]["CropLatentsCoreInvocation"] | components["schemas"]["NoiseInvocation"] | components["schemas"]["IdealSizeInvocation"] | components["schemas"]["SDXLModelLoaderInvocation"] | components["schemas"]["FloatCollectionInvocation"] | components["schemas"]["RangeInvocation"] | components["schemas"]["CoreMetadataInvocation"] | components["schemas"]["LoRALoaderInvocation"] | components["schemas"]["DynamicPromptInvocation"] | components["schemas"]["StringJoinInvocation"] | components["schemas"]["FloatToIntegerInvocation"] | components["schemas"]["ImageBlurInvocation"] | components["schemas"]["IterateInvocation"] | components["schemas"]["FaceMaskInvocation"] | components["schemas"]["CanvasPasteBackInvocation"] | components["schemas"]["MergeMetadataInvocation"] | components["schemas"]["IntegerInvocation"] | components["schemas"]["StringJoinThreeInvocation"] | components["schemas"]["FloatLinearRangeInvocation"] | components["schemas"]["MediapipeFaceProcessorInvocation"] | components["schemas"]["RandomIntInvocation"] | components["schemas"]["FaceOffInvocation"] | components["schemas"]["ImageScaleInvocation"] | components["schemas"]["ControlNetInvocation"] | components["schemas"]["StringSplitInvocation"] | components["schemas"]["MetadataInvocation"] | components["schemas"]["SDXLRefinerModelLoaderInvocation"] | components["schemas"]["PromptsFromFileInvocation"] | components["schemas"]["VAELoaderInvocation"] | components["schemas"]["BlendLatentsInvocation"] | components["schemas"]["BooleanCollectionInvocation"] | components["schemas"]["IntegerMathInvocation"] | components["schemas"]["MidasDepthImageProcessorInvocation"] | components["schemas"]["PairTileImageInvocation"] | components["schemas"]["ImageNSFWBlurInvocation"] | components["schemas"]["FloatMathInvocation"] | components["schemas"]["LeresImageProcessorInvocation"] | components["schemas"]["ImageCropInvocation"] | components["schemas"]["StringInvocation"] | components["schemas"]["CLIPSkipInvocation"] | components["schemas"]["ImageResizeInvocation"] | components["schemas"]["SDXLRefinerCompelPromptInvocation"] | components["schemas"]["RoundInvocation"] | components["schemas"]["CalculateImageTilesMinimumOverlapInvocation"] | components["schemas"]["CenterPadCropInvocation"] | components["schemas"]["ImagePasteInvocation"] | components["schemas"]["HedImageProcessorInvocation"] | components["schemas"]["SubtractInvocation"] | components["schemas"]["ResizeLatentsInvocation"] | components["schemas"]["ImageWatermarkInvocation"] | components["schemas"]["MaskCombineInvocation"] | components["schemas"]["ImageInvocation"] | components["schemas"]["UnsharpMaskInvocation"] | components["schemas"]["IntegerCollectionInvocation"] | components["schemas"]["LatentsToImageInvocation"] | components["schemas"]["FloatInvocation"] | components["schemas"]["CalculateImageTilesInvocation"] | components["schemas"]["ColorInvocation"] | components["schemas"]["ShowImageInvocation"] | components["schemas"]["BlankImageInvocation"] | components["schemas"]["StringReplaceInvocation"] | components["schemas"]["InfillColorInvocation"] | components["schemas"]["ImageChannelOffsetInvocation"];
      };
      /**
       * Edges
    ...
    GraphExecutionState: {
       ...
       */
      results: {
        [key: string]: components["schemas"]["NoiseOutput"] | components["schemas"]["FaceMaskOutput"] | components["schemas"]["LoRALoaderOutput"] | components["schemas"]["SDXLLoRALoaderOutput"] | components["schemas"]["FloatOutput"] | components["schemas"]["StringPosNegOutput"] | components["schemas"]["TileToPropertiesOutput"] | components["schemas"]["ConditioningCollectionOutput"] | components["schemas"]["IdealSizeOutput"] | components["schemas"]["LatentsOutput"] | components["schemas"]["VAEOutput"] | components["schemas"]["ImageCollectionOutput"] | components["schemas"]["CalculateImageTilesOutput"] | components["schemas"]["StringCollectionOutput"] | components["schemas"]["SDXLRefinerModelLoaderOutput"] | components["schemas"]["CLIPSkipInvocationOutput"] | components["schemas"]["T2IAdapterOutput"] | components["schemas"]["UNetOutput"] | components["schemas"]["IPAdapterOutput"] | components["schemas"]["SeamlessModeOutput"] | components["schemas"]["FaceOffOutput"] | components["schemas"]["ControlOutput"] | components["schemas"]["FloatCollectionOutput"] | components["schemas"]["SchedulerOutput"] | components["schemas"]["String2Output"] | components["schemas"]["IterateInvocationOutput"] | components["schemas"]["MetadataItemOutput"] | components["schemas"]["ConditioningOutput"] | components["schemas"]["DenoiseMaskOutput"] | components["schemas"]["IntegerOutput"] | components["schemas"]["ModelLoaderOutput"] | components["schemas"]["MetadataOutput"] | components["schemas"]["SDXLModelLoaderOutput"] | components["schemas"]["ImageOutput"] | components["schemas"]["StringOutput"] | components["schemas"]["BooleanCollectionOutput"] | components["schemas"]["CLIPOutput"] | components["schemas"]["ColorOutput"] | components["schemas"]["CollectInvocationOutput"] | components["schemas"]["ColorCollectionOutput"] | components["schemas"]["IntegerCollectionOutput"] | components["schemas"]["GradientMaskOutput"] | components["schemas"]["PairTileImageOutput"] | components["schemas"]["BooleanOutput"] | components["schemas"]["LatentsCollectionOutput"];
      };
      /**
       * Errors
     ...
     * @description Emitted when an invocation is started
     */
    InvocationStartedEvent: {
      /**
       * Timestamp
     ...
     * @description Emitted at each step during denoising of an invocation.
     */
    InvocationDenoiseProgressEvent: {
      /**
       * Timestamp
     ...
     * @description Emitted when an invocation is complete
     */
    InvocationCompleteEvent: {
      /**
       * Timestamp
     ...
     * @description Emitted when an invocation encounters an error
     */
    InvocationErrorEvent: {
      /**
       * Timestamp
    ...
    /**
     * SessionStartedEvent
     * @description Emitted when a session has started
     */
    SessionStartedEvent: {
      /**
       * Timestamp
     ...
     * @description Emitted when a session has completed all invocations
     */
    SessionCompleteEvent: {
      /**
       * Timestamp
     ...
     * @description Emitted when a session is canceled
     */
    SessionCanceledEvent: {
      /**
       * Timestamp
     ...
     * @description Emitted when a queue item's status changes
     */
    QueueItemStatusChangedEvent: {
      /**
       * Timestamp
    ...
    /**
     * BatchEnqueuedEvent
     * @description Emitted when a batch is enqueued
     */
    BatchEnqueuedEvent: {
      /**
       * Timestamp
    ...
    /**
     * QueueClearedEvent
     * @description Emitted when a queue is cleared
     */
    QueueClearedEvent: {
      /**
       * Timestamp
     ...
     * @description Emitted when a download is started
     */
    DownloadStartedEvent: {
      /**
       * Timestamp
     ...
     * @description Emitted at intervals during a download
     */
    DownloadProgressEvent: {
      /**
       * Timestamp
     ...
     * @description Emitted when a download is completed
     */
    DownloadCompleteEvent: {
      /**
       * Timestamp
     ...
     * @description Emitted when a download is cancelled
     */
    DownloadCancelledEvent: {
      /**
       * Timestamp
    ...
    /**
     * DownloadErrorEvent
     * @description Emitted when a download encounters an error
     */
    DownloadErrorEvent: {
      /**
       * Timestamp
     ...
     * @description Emitted when a model is requested
     */
    ModelLoadStartedEvent: {
      /**
       * Timestamp
     ...
     * @description Emitted at intervals while the install job is in progress (remote models only).
     */
    ModelInstallDownloadProgressEvent: {
      /**
       * Timestamp
     ...
     * @description Emitted when an install job is completed successfully.
     */
    ModelInstallCompleteEvent: {
      /**
       * Timestamp
     ...
     * @description Emitted when an install job is cancelled.
     */
    ModelInstallCancelledEvent: {
      /**
       * Timestamp
     ...
     * @description Emitted when an install job encounters an exception.
     */
    ModelInstallErrorEvent: {
      /**
       * Timestamp
     ...
     * @description Emitted when a bulk image download is started
     */
    BulkDownloadStartedEvent: {
      /**
       * Timestamp
